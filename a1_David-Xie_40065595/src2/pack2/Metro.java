...
public class Metro extends CityBus {
	...
	public String toString() {
		return ("This metro costs " + getPrice() + "$ and has " + getStops() + " stops." 
				+ " The route number is " + getRoute() + " and it began to operate in " + getOpYr() + 
				". The line name is " + getLineName() + " and the driver's name is " + getDriverName() + 
	...
	public boolean equals(Object otherObject) {
        ...
        else
        {
            ...
            return (getPrice() == otherMetro.getPrice() 
            		...
            		&& getRoute() == otherMetro.getRoute() 
            		&& getOpYr() == otherMetro.getOpYr() 
            		&& getLineName().equals(otherMetro.getLineName()) 
            		&& getDriverName().equals(otherMetro.getDriverName()) 
